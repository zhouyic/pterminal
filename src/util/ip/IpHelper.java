...
//		String file = IpHelper.class.getResource(ipFile).getFile();
		URL base = IpHelper.class.getResource(""); //先获得本类的所在位置，如/home/popeye/testjava/build/classes/net/  
		System.out.println("*************ipFilebase="+base+"**************");
        String path = new File(base.getFile(), "../../../../../../../../../../home/myconfig/ipDatabase.csv").getCanonicalPath(); //就可以得到/home/popeye/testjava/name
        System.out.println("*************ipFile="+path+"**************");
        BufferedReader ipRelationReader = FileUtil.readFile(path);
...
//		String file = IpHelper.class.getResource(regionFile).getPath();
		URL base = IpHelper.class.getResource(""); //先获得本类的所在位置，如/home/popeye/testjava/build/classes/net/  
		System.out.println("*************regionFileebase="+base+"**************");
		String path = new File(base.getFile(), "../../../../../../../../../../home/myconfig/ipRegion.xlsx").getCanonicalPath(); //就可以得到/home/popeye/testjava/name
		System.out.println("*************regionFile="+path+"**************");
