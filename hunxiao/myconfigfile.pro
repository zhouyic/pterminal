...
-libraryjars extendAgentx.jar
-libraryjars snmp4j-1.11.3.jar
-libraryjars snmp4j-agent-1.4.3.jar
-libraryjars snmp4j-agentx-1.3.3.jar
...
-keepnames class * implements org.snmp4j.agent.MOGroup

-keepclassmembers class * implements org.snmp4j.agent.MOGroup {
    !static !transient <fields>;
    !private <fields>;
    !private <methods>;
    private void writeObject(java.io.ObjectOutputStream);
